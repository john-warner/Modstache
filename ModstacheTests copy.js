...
test('Test with array', async function (assert) {
...
test('Test with child array', async function (assert) {
...
test('Test with array push', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array unshift', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array splice', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array pop', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array shift', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array index assignment', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array index swap', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array sort', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
...
test('Test with array length assignment', async function (assert) {
    var html = '<div><div {}="text"></div></div>';
    var data = { text: [{ text: 'One'}, { text: 'Two' }] };
    var template = document.createElement("template");
...
test('Test with array modified template', async function (assert) {
...
test('Test with array mustache replacement', async function (assert) {
